...
def train_and_evaluate_nn(train_x_orig, train_y, test_x_orig, test_y, dev_x, dev_y):
    ...
    parameters = L_layer_model(train_x, train_y, layers_dims, learning_rate=0.25, num_iterations=10000, print_cost=True,
                               dynamic_grad_change=False, point_of_change=0.31, second_value=0.05)
    print("\n*NEURAL NET:")
    print("Training", end=" ")
